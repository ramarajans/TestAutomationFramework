...
public class DriverFactory {
	...
	private static String overWriteExtentReport;
	...
	public static String getOverWriteExtentReport() {
		return overWriteExtentReport;
	}
	public static void setOverWriteExtentReport(String string) {
		DriverFactory.overWriteExtentReport = string;
	}
